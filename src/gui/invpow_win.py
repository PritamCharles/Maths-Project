...
class InversedPowerWindow:
    ...
    def show_parameters(self, root):
        ...
        tk.Label(frame1, text="Paramètres choisis:", font=("Comic Sans MS", 7, "underline"), bg="#2F2F40", fg="white").grid(row=1, column=1)
        ...
        tk.Label(frame1, text=str(self.combo_invm_value), font=("Comic Sans MS", 7), bg="#2F2F40", fg="white").grid(row=3, column=2)
    ...
    def show_matrix(self, root):
        ...
        tk.Label(frame2, text="Matrice d'étude", font=("Comic Sans MS", 12, "underline"), bg="#2F2F40", fg="white").grid(row=1, column=1, pady=10)
    ...
    def show_results(self, root):
        ...
        tk.Label(frame3, text="Nombre d'itérations", font=("Comic Sans MS", 12, "underline"), bg="#2F2F40", fg="white").grid(row=1, column=1, pady=(0, 10))
        tk.Label(frame3, text="Approximation de la plus petite valeur propre", font=("Comic Sans MS", 12, "underline"), bg="#2F2F40", fg="white").grid(row=3, column=1, pady=(0, 10))
        tk.Label(frame3, text="Approximation du vecteur propre", font=("Comic Sans MS", 12, "underline"), bg="#2F2F40", fg="white").grid(row=5, column=1, pady=(0, 10))
        tk.Label(frame3, text="Différence ||w(k) - w(k-1)||", font=("Comic Sans MS", 12, "underline"), bg="#2F2F40", fg="white").grid(row=7, column=1, pady=(0, 10))

        tk.Label(frame3, text=str(self.nbiter), font=("Comic Sans MS", 12), bg="#2F2F40", fg="white").grid(row=2, column=1, pady=(0, 40))

        if self.combo2_value == "Personnalisée":
            tk.Label(frame3, text=str(self.leigvec), font=("Comic Sans MS", 12), bg="#2F2F40", fg="white").grid(row=6, column=1, pady=(0, 40))

        if (self.combo2_value == "Aléatoire") or (self.combo2_value == "Aléatoire à coeffs entiers") or (self.combo2_value == "Matrice de Hilbert"):
            if self.array_size_value <= 5:
                tk.Label(frame3, text=str(self.leigvec), font=("Comic Sans MS", 10), bg="#2F2F40", fg="white").grid(row=6, column=1, pady=(0, 40))
            elif self.array_size_value > 5:
                tk.Label(frame3, text="(Trop grand pour être affiché)", font=("Comic Sans MS", 10), bg="#2F2F40", fg="white").grid(row=4, column=1, pady=(0, 40))
                print("Approximation du vecteur propre de la plus petite valeur propre:", self.leigvec)

        tk.Label(frame3, text=str(self.leigval), font=("Comic Sans MS", 12), bg="#2F2F40", fg="white").grid(row=4, column=1, pady=(0, 40))
