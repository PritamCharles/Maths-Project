...
class IteratedPowerWindow:
    ...
    def show_results(self, root):
       ...
       tk.Label(frame3, text="Vecteur propre de la plus grande valeur propre", font=("Comic Sans MS", 12), bg="#2F2F40", fg="white").grid(row=3, column=1, pady=(0, 10))
       tk.Label(frame3, text="Plus grande valeur propre", font=("Comic Sans MS", 12), bg="#2F2F40", fg="white").grid(row=5, column=1, pady=(0, 10))
       tk.Label(frame3, text="Différence ||wk - wk-1||", font=("Comic Sans MS", 12), bg="#2F2F40", fg="white").grid(row=7, column=1, pady=(0, 10))
