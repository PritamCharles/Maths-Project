...
class CondChartWindow:
    def __init__(self):
        self.win = w.Window()
        self.menu_bar = mb.MenuBar()

    def show_image(self, canvas):
        img = Image.open("./src/gui/img/cond_error_chart.png")
        resized_img = img.resize((750, 450))
        resized_img.save("./src/gui/img/cond_error_chart_resized.png")
        img2 = tk.PhotoImage(file="./src/gui/img/cond_error_chart_resized.png")
